...
void getDataFor3pDecay()
{
    ...
    df_angles = df_angles.Define("epsilon1", [&](threeAngles& a) { return a.theta1 / (a.theta1 + a.theta2 + a.theta3); },
                     {"threeAngles"})
              .Define("epsilon2", [&](threeAngles& a) { return a.theta2 / (a.theta1 + a.theta2 + a.theta3); },
                      {"threeAngles"})
              .Define("epsilon3", [&](threeAngles& a) { return a.theta3 / (a.theta1 + a.theta2 + a.theta3); },
                      {"threeAngles"});
